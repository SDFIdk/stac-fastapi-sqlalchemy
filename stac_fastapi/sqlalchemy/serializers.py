...
from stac_fastapi.types.rfc3339 import datetime_to_str, now_to_rfc3339_str, rfc3339_str_to_datetime
...
class ItemSerializer(Serializer):
    ...
    def db_to_stac(cls, db_model: database.Item, hrefbuilder: ApiTokenHrefBuilder) -> stac_types.Item:
        ...
        add_links = [
            {
                "rel": "license",
                "href": "https://www.klimadatastyrelsen.dk/om-os/vilkaar-og-priser",
        ...
        properties["providers"] = [
            ...
            {"url": "https://www.klimadatastyrelsen.dk/", "name": "Klimadatastyrelsen", "roles": ["licensor", "host"]},
        ]    
        ...
        properties["pers:interior_orientation"] = {
            ...
            "calibration_date": db_model.calibration_date,
